        ...
        <div>
            <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
                <div className="relative py-3 sm:max-w-xl sm:mx-auto">
                    <div
                        className="absolute inset-0 bg-gradient-to-r from-emerald-300 to-emerald-600 shadow-lg transform -skew-y-6 sm:skew-y-0 sm:-rotate-6 sm:rounded-3xl">
                    </div>
                                    ...
                                    <form>
                                        <div className="relative">
                                            <input autoComplete="off" name="email" type="text"
                                                   ...
                                                   placeholder="Email address" defaultValue='test@test.dev'/>
                                            <label htmlFor="email"
                                        ...
                                        <div className="relative my-4">
                                            <input autoComplete="off" name="password" type="password"
                                                   className="peer placeholder-transparent h-10 w-full border-b-2 border-gray-300 text-gray-900 focus:outline-none focus:borer-rose-600"
                                                   placeholder="Password" defaultValue='test123'/>
                                        ...
                                        <div className="relative">
                                            <button
                                                className="bg-emerald-500 text-white rounded-md px-2 py-1"
                                                onClick={ onLogin }
                                            >
                                                Login
                                            </button>
